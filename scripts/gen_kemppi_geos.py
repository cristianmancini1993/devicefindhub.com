...
<link rel="canonical" href="https://devicefindhub.com/{geo}/{slug}/landing.html">
</head>
<body>
...
<footer class="site-footer">
  <div class="container">
    <div class="site-footer__grid">
      <div>
        <a href="/" class="site-logo" aria-label="devicefindhub.com home">
          <span class="site-logo__text"><span class="site-logo__text-primary">devicefindhub</span><span class="site-logo__text-accent">.com</span></span>
        </a>
    ...
    <div class="site-footer__bottom">
      © <span data-year>2026</span> <strong>The Lead Empire L.L.C-FZ</strong> — {rights}.
      <a href="/">devicefindhub.com</a>
    </div>
  </div>
</footer>
...
def render_thank_you(offer: str, cfg: dict, copy: dict, shared: dict, it_ty: str) -> str:
    ...
    html = html.replace(
        "Il team devicefindhub al lavoro: call center e logistica COD", shared["ty_alt"]
    )
...
def update_sitemap() -> None:
    ...
    for offer, cfg in GEOS.items():
        geo = cfg["geo"]
        slug = cfg["slug"]
        for loc in (f"https://devicefindhub.com/{geo}/{slug}/", f"https://devicefindhub.com/{geo}/{slug}/landing.html"):
            line = f'  <url><loc>{loc}</loc><lastmod>2026-08-11</lastmod><changefreq>weekly</changefreq><priority>0.95</priority></url>\n'
            if loc not in text:
                entries.append(line)
    if not entries:
        return
    marker = '  <url><loc>https://devicefindhub.com/en/kemppi/landing.html</loc><lastmod>2026-08-11</lastmod><changefreq>weekly</changefreq><priority>0.95</priority></url>\n'
    if marker in text:
